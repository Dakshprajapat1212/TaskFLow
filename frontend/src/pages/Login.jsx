...
import { LayoutDashboard, ArrowRight, CheckCircle, Mail, Lock } from 'lucide-react';
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          <div className="mb-8">
            ...
            <p className="text-xl text-white/70 max-w-md leading-relaxed">
              Streamline your workflow, collaborate with your team, and deliver projects on time with our intuitive task management platform.
            </p>
          </div>
